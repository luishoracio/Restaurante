...
public class MenuActivity extends ActionBarActivity {
    ...
    private void obtenerDatosInternet() {
        if (hayConexion()){
            ObtenerInformacionInternet obtenerInformacionInternet =
                    new ObtenerInformacionInternet();
    ...
    private class ObtenerInformacionInternet extends AsyncTask<Object,Void, String>{
        ...
        protected String doInBackground(Object... objects){
            ...
            try{
                URL url = new URL("http://continentalrescueafrica.com/2013/testRestaurant.php");
        ...
        protected void onPostExecute(String respuesta){
            ...
            try {
                ...
                for(int i = 0; i< jsonArray.length(); i++ ){
                    ...
                    hashMap.put("platillo", jsonObject.getString("platillo"));
                    hashMap.put("precio", jsonObject.getString("precio"));
                    hashMap.put("ingredientes", jsonObject.getString("ingredientes"));
