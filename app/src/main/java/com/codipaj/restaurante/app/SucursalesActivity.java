...
public class SucursalesActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView)findViewById(R.id.listSucursales);
    ...
    private void poblarLista() {
        ...
        HashMap <String , String> sucursal =
                new HashMap<String, String>();
        sucursal.put("Sucursal", "Centro");
        sucursal.put("Telefono", "1234567");
        sucursal.put("Coordenada", "28.708138,-106.104755");

        lista.add(sucursal);

        HashMap <String , String> sucursal2 =
                new HashMap<String, String>();
        sucursal2.put("Sucursal", "Norte");
        sucursal2.put("Telefono", "2345678");
        sucursal2.put("Coordenada", "28.708138,-106.104755");
        lista.add(sucursal2);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            //Toast.makeText(getApplicationContext(), "Sucursal: " + nombre,
            //        Toast.LENGTH_SHORT).show();
            String coordenada = hashMapSeleccionado.get("Coordenada");

            String uri = "geo:"+ coordenada +
                    "?q=" + coordenada +
                    "(" + nombre + ")";
